...
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd(keepass))
hl.bind(altMod .. " + B", hl.dsp.exec_cmd(browser .. " --private-window"))
...
hl.bind(altMod .. " + n", hl.dsp.exec_cmd("swaync-client -d"))
...
hl.bind(altMod .. " + w", hl.dsp.exec_cmd("killall -SIGUSR2 waybar || waybar"))
